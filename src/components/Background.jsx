    ...
    return (
        <div className="bg-container">
            ...
            <div className="bg-vectors">
                <svg className="vector vector-1" width="200" height="200" viewBox="0 0 100 100" fill="none" aria-hidden="true">
                ...
                <svg className="vector vector-2" width="150" height="150" viewBox="0 0 120 120" fill="none" aria-hidden="true">
                ...
                <svg className="vector vector-3" width="120" height="120" viewBox="0 0 80 80" fill="none" aria-hidden="true">
                ...
                <svg className="vector vector-4" width="300" height="100" viewBox="0 0 300 100" fill="none" aria-hidden="true">
