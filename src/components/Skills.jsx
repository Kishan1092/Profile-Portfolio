        ...
        <section id="skills" className="skills">
            <div className="container">
                <div className="section-header animate-in">
                    ...
                    <p className="section-subtitle">End-to-end expertise across AI tools, intelligent product design, vibe coding, and modern frontend architecture—enabling rapid prototyping, clean scalable implementation, and delivery of high-performance, user-centric web applications from concept to production.</p>
                </div>
